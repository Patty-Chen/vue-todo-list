...
var Todo = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Object.extend('Todo');

  var app1 = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#app',
  data: {
    newTodo: '',
    todoList: [],
  ...
  methods: {
    saveTodo: function(){
      let acl = new __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.ACL();
      acl.setReadAccess(__WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.User.current(),true);
    ...
    readTodo: function(){
      let query = new __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Query('Todo');
    ...
    logout:function (){
      ...
      this.currentUser = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.User.current();
      this.todo = null;
      this.todoList = [];
    }
  }
